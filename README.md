...
Associated with a quick channel forwarder for USB Loader GX "apps/usbloader_gx/boot.dol", that you need to install on Priiloader, and you end up with a clean, fast boot to your games!
